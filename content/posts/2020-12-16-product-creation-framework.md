...
This post is a transcription from the podcasts of the season 2 and is structured around 7 main axes which are :
...
To finish, don't hesitate to ask to clarify a customer's answer when it is not understood.
...
When you havee done the phone calls, and defined personas, you can send your first customer a questionnaire.\
...
Helpful tip : Repeat the end of an answer with the last word in the tone of the query. Ex: *"- I like this aspect. - Oh, this aspect?"*
...
Value sought by the user => saving time, money or social recognition => creation of a bubble of honesty

If people pay a lot for the product/service, they will be honest.

By existing love of the product => modifying an existing feature to working well => real feedback

Cash should drive the product improvements in post product market-fit.

#### 3) Prioritize the improvements

Careful with the relevance of the feedbacks. 1 person speaks => 10 people think the same thing. It is weighted by the added value of the feature (time spent, potential money gain).

Anything you can sell that doesn't exist yet should be able to be developed.

## VI. Organization and execution

Sprint 1-2 weeks => User story

Main metric ? Related to use/users or sales

Follow-up of the AARRR funnel
...
* UX/UI Designer
  ...
  * SS: knows how to build a user path, creatively and
