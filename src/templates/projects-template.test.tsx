...
import ProjectsTemplate, { Head as GatsbyHead } from "./projects-template";
...
describe("ProjectsTemplate", () => {
  ...
  test("renders correctly", () => {
    const tree = createSnapshotsRenderer(<ProjectsTemplate {...props} />).toJSON();
  ...
  test("head renders correctly", () => {
    ...
    expect(getMeta(container, "twitter:title")).toEqual("Projects - Page 2 - Blog by John Doe");
    expect(getMeta(container, "og:title")).toEqual("Projects - Page 2 - Blog by John Doe");
